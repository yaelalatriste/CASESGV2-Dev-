...
{
    public class RepositorioFumigacion : IRepositorioFumigacion
    {
        private readonly string _connectionString;

        public RepositorioFumigacion(IConfiguration configuration)
        {
            _connectionString = configuration.GetConnectionString("DatabaseConnection"); ;
        }

        public async Task<List<VCedulas>> GetCedulasFumigacion(int user)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_getCedulasFumigacion", sql))
                    {
            ...
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_verificaPeriodo", sql))
                    {
                        ...
                        cmd.Parameters.Add(new SqlParameter("@servicio", 2));
                        await sql.OpenAsync();
        ...
        public async Task<int> insertaCedula(CedulaFumigacion cedulaFumigacion)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_nuevaCedulaFumigacion", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@id", cedulaFumigacion.Id)).Direction = System.Data.ParameterDirection.Output;
                        cmd.Parameters.Add(new SqlParameter("@usuario", cedulaFumigacion.UsuarioId));
                        cmd.Parameters.Add(new SqlParameter("@inmueble", cedulaFumigacion.InmuebleId));
                        cmd.Parameters.Add(new SqlParameter("@folio", generaFolio(cedulaFumigacion.InmuebleId,cedulaFumigacion.Mes)));
                        cmd.Parameters.Add(new SqlParameter("@mes", cedulaFumigacion.Mes));
                        cmd.Parameters.Add(new SqlParameter("@anio", cedulaFumigacion.Anio));
        ...
        public async Task<CedulaFumigacion> CedulaById(int id)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_cedulaFumigacionById", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@id", id));
                        CedulaFumigacion response = null;
                        await sql.OpenAsync();
        ...
        public async Task<int> GuardaRespuestas(List<RespuestasEncuesta> respuestasEncuestas)
        {
            ...
            try
            {
                foreach (var r in respuestasEncuestas)
                {
                    using (SqlConnection sql = new SqlConnection(_connectionString))
                    {
                        using (SqlCommand cmd = new SqlCommand("sp_insertaActualizaRespuestasFumigacion", sql))
                        {
                            cmd.CommandType = CommandType.StoredProcedure;
                            cmd.Parameters.Add(new SqlParameter("@id", SqlDbType.Int)).Direction = ParameterDirection.Output;
                            cmd.Parameters.Add(new SqlParameter("@cedula", r.CedulaFumigacionId));
        ...
        public async Task<List<RespuestasEncuesta>> obtieneRespuestas(int id)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_getRespuestasFumigacion", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@id", id));
        ...
        public async Task<int> enviaRespuestas(int cedula)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_calculaCalificacionFumigacion", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public async Task<int> apruebaRechazaCedula(CedulaFumigacion cedulaFumigacion)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    ...
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@id", cedulaFumigacion.Id));
                        cmd.Parameters.Add(new SqlParameter("@estatus", cedulaFumigacion.Estatus));
                        cmd.Parameters.Add(new SqlParameter("@servicioId", 2));
        ...
        public async Task<int> capturaHistorial(HistorialCedulas historialCedulas)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    ...
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@servicio", "Fumigación"));
        ...
        public async Task<List<HistorialCedulas>> getHistorialFumigacion(object id)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
        ...
        private CedulaFumigacion MapToValueCedula(SqlDataReader reader)
        {
            return new CedulaFumigacion()
            {
                Id = (int)reader["Id"],
