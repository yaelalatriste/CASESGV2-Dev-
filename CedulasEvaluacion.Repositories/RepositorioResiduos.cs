...
{
    public class RepositorioResiduos : IRepositorioResiduos
    {
        private readonly string _connectionString;
        public RepositorioResiduos(IConfiguration configuration)
        {
            _connectionString = configuration.GetConnectionString("DatabaseConnection");
        }

        public async Task<List<VCedulas>> GetCedulasResiduos(int user)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_getCedulasResiduos", sql))
                    {
            ...
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_verificaPeriodo", sql))
                    {
                        ...
                        cmd.Parameters.Add(new SqlParameter("@servicio", 7));
                        await sql.OpenAsync();
        ...
        public async Task<int> insertaCedula(Residuos residuos)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_nuevaCedulaResiduos", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@id", residuos.Id)).Direction = System.Data.ParameterDirection.Output;
                        cmd.Parameters.Add(new SqlParameter("@inmueble", residuos.InmuebleId));
                        cmd.Parameters.Add(new SqlParameter("@usuario", residuos.UsuarioId));
                        cmd.Parameters.Add(new SqlParameter("@folio", generaFolio(residuos.InmuebleId,residuos.Mes)));
                        cmd.Parameters.Add(new SqlParameter("@mes", residuos.Mes));
                        cmd.Parameters.Add(new SqlParameter("@anio", residuos.Anio));
        ...
        public async Task<Residuos> CedulaById(int id)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_cedulaResiduosById", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@id", id));
                        Residuos response = null;
                        await sql.OpenAsync();
        ...
        public async Task<int> GuardaRespuestas(List<RespuestasEncuesta> respuestasEncuestas)
        {
            ...
            try
            {
                foreach (var r in respuestasEncuestas)
                {
                    using (SqlConnection sql = new SqlConnection(_connectionString))
                    {
                        using (SqlCommand cmd = new SqlCommand("sp_insertaActualizaRespuestasResiduos", sql))
                        {
                            cmd.CommandType = CommandType.StoredProcedure;
                            cmd.Parameters.Add(new SqlParameter("@id", SqlDbType.Int)).Direction = ParameterDirection.Output;
                            cmd.Parameters.Add(new SqlParameter("@cedula", r.CedulaResiduosId));
        ...
        public async Task<List<RespuestasEncuesta>> obtieneRespuestas(int id)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_getRespuestasResiduos", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@id", id));
        ...
        public async Task<int> enviaRespuestas(int cedula)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_calculaCalificacionResiduos", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public async Task<int> apruebaRechazaCedula(Residuos residuos)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    ...
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@id", residuos.Id));
                        cmd.Parameters.Add(new SqlParameter("@estatus", residuos.Estatus));
                        cmd.Parameters.Add(new SqlParameter("@servicioId", 7));
        ...
        public async Task<int> capturaHistorial(HistorialCedulas historialCedulas)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    ...
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@servicio", "RPBI"));
        ...
        public async Task<List<HistorialCedulas>> getHistorialResiduos(object id)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
        ...
        private Residuos MapToValueCedula(SqlDataReader reader)
        {
            return new Residuos()
            {
                Id = (int)reader["Id"],
