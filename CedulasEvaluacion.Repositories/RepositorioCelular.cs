...
{
    public class RepositorioCelular : IRepositorioCelular
    {
        private readonly string _connectionString;

        public RepositorioCelular(IConfiguration configuration)
        {
            ...
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_verificaPeriodo", sql))
                    {
                        ...
                        cmd.Parameters.Add(new SqlParameter("@servicio", 5));
                        await sql.OpenAsync();
        ...
        public async Task<int> insertaCedula(TelefoniaCelular telefoniaCelular)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_nuevaCedulaCelular", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@id", telefoniaCelular.Id)).Direction = System.Data.ParameterDirection.Output;
                        cmd.Parameters.Add(new SqlParameter("@usuario", telefoniaCelular.UsuarioId));
                        cmd.Parameters.Add(new SqlParameter("@folio", generaFolio(telefoniaCelular.Mes)));
                        cmd.Parameters.Add(new SqlParameter("@mes", telefoniaCelular.Mes));
                        cmd.Parameters.Add(new SqlParameter("@anio", telefoniaCelular.Anio));
        ...
        public async Task<TelefoniaCelular> CedulaById(int id)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_cedulaCelularById", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@id", id));
                        TelefoniaCelular response = null;
                        await sql.OpenAsync();
        ...
        public async Task<int> GuardaRespuestas(List<RespuestasEncuesta> respuestasEncuestas)
        {
            ...
            try
            {
                foreach (var r in respuestasEncuestas)
                {
                    using (SqlConnection sql = new SqlConnection(_connectionString))
                    {
                        using (SqlCommand cmd = new SqlCommand("sp_insertaActualizaRespuestasCelular", sql))
                        {
                            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<List<RespuestasEncuesta>> obtieneRespuestas(int id)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_getRespuestasCelular", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@id", id));
        ...
        public async Task<int> enviaRespuestas(int cedula)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_calculaCalificacionCelular", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public async Task<int> apruebaRechazaCedula(TelefoniaCelular telefoniaCelular)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    ...
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@id", telefoniaCelular.Id));
                        cmd.Parameters.Add(new SqlParameter("@estatus", telefoniaCelular.Estatus));
                        cmd.Parameters.Add(new SqlParameter("@servicioId", 5));
        ...
        public async Task<int> capturaHistorial(HistorialCedulas historialCedulas)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
                {
                    ...
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@servicio", "Telefonía Celular"));
        ...
        public async Task<List<HistorialCedulas>> getHistorialCelular(object id)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
        ...
        private TelefoniaCelular MapToValueCedula(SqlDataReader reader)
        {
            return new TelefoniaCelular()
            {
                Id = (int)reader["Id"],
